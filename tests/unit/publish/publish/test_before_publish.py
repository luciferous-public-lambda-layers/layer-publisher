...
class Test_GenerateLayerContentUri:
    @pytest.mark.parametrize(
        "option, expected",
        [
            (
                {"arch": index.Architecture.ARM, "runtime": "python3.13"},
                ["      ContentUri: modules/arm/python3.13"],
            ),
            (
                {"arch": index.Architecture.AMD, "runtime": "python3.11"},
                ["      ContentUri: modules/amd/python3.11"],
            ),
            (
                {"arch": index.Architecture.NONE, "runtime": "python3.9"},
                ["      ContentUri: modules/amd/python3.9"],
            ),
        ],
    )
    def test_normal(self, option, expected):
        actual = index._generate_layer_content_uri(**option)
        assert actual == expected
        ...
        [
            (
                ...
                [
                    ...
                    "      ContentUri: modules/amd/python3.13",
                    "      LayerName: LuciferousPublicLayerAwsCloudwatchLogsUrlPython313",
                    "      CompatibleArchitectures:",
                    "        - arm64",
                    "        - x86_64",
            ...
            (
                ...
                [
                    ...
                    "    Properties:",
                    "      RetentionPolicy: Retain",
                    "      ContentUri: modules/arm/python3.10",
        ...
        [
            (
                ...
                [
                    ...
                    "    Properties:",
                    "      RetentionPolicy: Retain",
                    "      ContentUri: modules/amd/python3.12",
                    ...
                    "    Properties:",
                    "      RetentionPolicy: Retain",
                    "      ContentUri: modules/amd/python3.10",
            ...
            (
                ...
                [
                    ...
                    "    Properties:",
                    "      RetentionPolicy: Retain",
                    "      ContentUri: modules/arm/python3.12",
                    ...
                    "    Properties:",
                    "      RetentionPolicy: Retain",
                    "      ContentUri: modules/arm/python3.11",
                    ...
                    "    Properties:",
                    "      RetentionPolicy: Retain",
                    "      ContentUri: modules/arm/python3.9",
                    "      LayerName: LuciferousPublicLayerZstdPython39Arm",
                    "      CompatibleArchitectures:",
                    "        - arm64",
                    "      CompatibleRuntimes:",
